# app/services/parsers/parse_movimiento_barril.py
import openai
import json
...
async def parse_movimiento_barril(mensaje: str, user: str) -> dict:
    prompt = f"""
Extraé los datos necesarios para registrar un movimiento de barril vacío (retorno o entrega).

Campos requeridos:
- id_barril (número identificador del barril)
...
"""
    ...
    try:
        ...
        campos_obligatorios = ["id_barril", "tipo", "responsable", "mensaje_original"]
        ...
        return {
            ...
            "faltantes": faltantes,
            "datos": datos,
            "tabla_destino": "MovimientoBarril"
        }
